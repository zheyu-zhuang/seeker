...
def _default_texture_dir() -> str:
    return str(load_path_config().textures_dir)
...
def sample_random_texture(
    ...
    *,
    ...
    """Sample one texture uniformly at random from train/eval split."""
    ...
    if hasattr(rng, "integers"):
        ...
        raise TypeError("rng must provide .integers or .randint")
    return files[idx]

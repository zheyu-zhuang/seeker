...
Commands:
  setup              Install suite deps and download release assets (recommended first step)
  ...
  setup-assets       Download release assets only (no suite deps)

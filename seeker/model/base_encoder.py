"""Shared encoder input preprocessing and validation utilities.

This module defines the base class used by model encoders to transform raw
...
class BaseEncoder(nn.Module):
    """Common preprocessing base for all observation encoders.
    ...
    def obs_to_input(
        ...
        norm_keys = [k["eef_pos"], k["eef_rot"], k["gripper"], "task_embedding", "robot_id"]
